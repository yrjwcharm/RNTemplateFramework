...
import {View,StyleSheet, SafeAreaView,Image,TouchableOpacity,Text,TextInput} from 'react-native' ;
import Title from '../components/Title'
import {Input} from "teaset";
import BusinessQuery from "./home/BusinessQuery";
    ...
    render() {
        ...
        return (
            <SafeAreaView style={{flex:1,backgroundColor:'#eee'}}>
                <Title title="登录" />
                <View style={{marginHorizontal:moderateScale(45),marginTop:moderateScale(120),borderRadius: scale(5),
                ...
                <SmallButton name={'登录'} onPress={this._login}/>
                </View>
            </SafeAreaView>
        );
    }
